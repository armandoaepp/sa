<?php
	/*
		Autor			:	ARMANDO ENRIQUE PISFIL PUEMAPE -> @armandoaepp
	  	Fecha			:	19/07/2014
	...
	*/
	...
	function ClsUsuario($cnx  = null  )
	{
			...
			{
				$cUserName  = $bean_perusuario->getcPerUsuCodigo() ;
				$cUserClave = $bean_perusuario->getcPerUsuClave() ;

			// return "call usp_Get_Usuario_By_Clave_UserName('$cUserName','$cUserClave')";
			...
			{
				// return "Call usp_Get_Permisos_By_Usuario($nPerTipo, $nPerEstado, $nPerUsuEstado, $nPerUsuAccEstado, $nParClase, $nPercodigo, $nPerUsuAccGrupo)";
			...
			function Get_Permisos_Botonera_By_Usuario(	$nPerTipo, $nPerEstado, $nPerUsuEstado,	$nPerUsuAccEstado,
				$nParClase,	$nPercodigo,	$nPerUsuAccGrupo,	$nParTipo,	$nParSrcClase,	$nParSrcCodigo)
			{
				// return "Call usp_Get_Permisos_Botonera_By_Usuario($nPerTipo, $nPerEstado, $nPerUsuEstado, $nPerUsuAccEstado, $nParClase, $nPercodigo, $nPerUsuAccGrupo, $nParTipo, $nParSrcClase, $nParSrcCodigo)";
