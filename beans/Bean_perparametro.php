...
class Bean_perparametro{
//Constructor
	public function Bean_perparametro(){}
//Atributos
	private $cPerCodigo;
	private $nParCodigo;
	private $nParClase;
...
//Propiedades
	...
	public function setcPerParValor($cPerParValor_){ $this->cPerParValor=$cPerParValor_;}
	public function getcPerParValor(){ return $this->cPerParValor;}
