...
<body onload="xajax_MostrarMenus(10);">
	<!--Fondo Transparente-->
    <div id="vidrio" style="z-index: 11;">
    </div>

	 <!--fondo transparente espera-->
    <div id="vidrio_espera_" class="vidrio_espera_ ">
    </div>
      <!--ventana emergente espera-->
      <div id="popup_espera_" class="popup_espera_ " >
      </div>
	...
	<script src="./js/jquery.validar.campo.js"></script>
